...
Gem::Specification.new do |s|
  ...
  s.version     = "0.5.1.1"
  s.authors     = ["Mick Staugaard", "Luke Antins", 'Sergio Tulentsev', 'Jon Mumm']
  s.email       = ["mick@zendesk.com", "luke@lividpenguin.com", 'sergei.tulentsev@gmail.com', 'jonathanrmumm@gmail.com']
